package com.example.administrator.avdemo.helper;
...
import com.example.administrator.avdemo.viewinterface.LogoutView;
import com.example.administrator.avdemo.viewinterface.Presenter;
...
//                Toast.makeText(mContext, "OnPwdLoginTimeout：\n" +tlsErrInfo.ErrCode+ tlsErrInfo.Msg, Toast.LENGTH_SHORT).show();
                Toast.makeText(mContext, "OnPwdLoginTimeout：\n" +tlsErrInfo.ErrCode,Toast.LENGTH_SHORT).show();
