package com.example.administrator.avdemo.common;
...
public class Constants {
    ...
    //appid 与 account_type 由开发者填入自己的
    public static final int SDK_APPID = 1400012716;

    public static final int ACCOUNT_TYPE = 6593;
